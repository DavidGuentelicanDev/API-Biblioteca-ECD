...
urlpatterns = [
    ...
    path('admin/libros/<str:codigo>/', LibroRetrieveUpdateDeleteAPIView.as_view(), name='admin_libros_detalle_editar_eliminar'),
    ...
    path('web/libros/<str:codigo>/', LibroRetrieveAPIView.as_view(), name='web_libros_detalle'),
]